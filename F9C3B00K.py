...
#The Credit For This Code Goes To harimmd
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://youtube.com/channel/UCWQ3pxOv7qZeLu-3rGKnuBQchannel/UCWQ3pxOv7qZeLu-3rGKnuBQ')
...
def login():
	...
	try:
		...
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mHariMmd\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def pilih_super():
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By mmd-hacker--тАвтЧИтАв---┬╗" #Dev:baloch_hacker
...
: \033[1;93m.Mmdhacker  Harimmd.... \033[1;93m :
